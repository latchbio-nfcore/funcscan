...
- `ampcombi/`
  ...
  - `Ampcombi_parse_tables.log`:log file containing the run information from AMPcombi submodule `ampcombi/parsetables`.
  - `Ampcombi_complete.log`:log file containing the run information from AMPcombi submodule `ampcombi/complete`.
  ...
  - `Ampcombi_cluster.log`:log file containing the run information from AMPcombi submodule `ampcombi/cluster`.
